"""
Train CartPole on GPU (for remote Linux machine with CUDA)
...
def main():
    ...
    print("Training for 100k timesteps (~1-2 minutes on RTX 3090)")
    print("="*60 + "\n")
    ...
    model_path = os.path.join(model_dir, "cartpole_ppo_100k_gpu.zip")
    ...
    for episode in range(10):
        ...
        while True:
            ...
            if terminated or truncated:
                ...
                status = "SUCCESS" if episode_reward >= 500 else "PARTIAL"
    ...
    print(f"Perfect scores (500): {sum(1 for r in episode_rewards if r >= 500)}/10")
    print(f"{'='*60}")
